...
def render_msmarco_section(
        ...
        rows.append(
            {
                ...
                "scores": [entry.get(key) for key, _ in MSMARCO_METRICS],
    ...
    header = ["#", "Model"] + [label for _, label in MSMARCO_METRICS] + ["Date"]
    table_rows = [
        [str(rank), row["model"]]

...
def main() -> None:
    ...
    sections = [
        "# Benchmark Results",
        (f"_Generated by `results/generate_report.py` on "
        f"{datetime.now().strftime('%Y-%m-%d')}. Do not edit manually._\n\n"
        ...
        render_retrieval_section(
            ...
            "validation split). Ranked by the task main score, MRR@10.",
        ),
        render_retrieval_section(
            msmarco_metrics,
            MSMARCO_EN_TASK,

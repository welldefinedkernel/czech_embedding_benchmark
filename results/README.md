...
_Generated by `results/generate_report.py` on 2026-08-16. Do not edit manually._
...
The same task after rescoring each retriever's top 100 documents with [`jinaai/jina-reranker-v2-base-multilingual`](https://huggingface.co/jinaai/jina-reranker-v2-base-multilingual). ΔMRR@10 is measured against section 3. Recall@100 is unchanged.

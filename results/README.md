...
_Generated by `results/generate_report.py` on 2026-08-13. Do not edit manually._
...
| # | Model | MRR@10 | nDCG@10 | MAP@10 | Recall@1 | Recall@10 | Recall@20 | Recall@100 | Date |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [`BAAI/bge-m3`](mteb/ctdc_synthetic/BAAI__bge-m3/) | 0.7857 | 0.8223 | 0.7856 | 0.6986 | 0.9345 | 0.9583 | 0.9876 | 2026-08-04 |
| 2 | [`microsoft/harrier-oss-v1-27b`](mteb/ctdc_synthetic/microsoft__harrier-oss-v1-27b/) | 0.7829 | 0.8216 | 0.7828 | 0.6900 | 0.9405 | 0.9650 | 0.9915 | 2026-08-04 |
| 3 | [`tencent/KaLM-Embedding-Gemma3-12B-2511`](mteb/ctdc_synthetic/tencent__KaLM-Embedding-Gemma3-12B-2511/) | 0.7798 | 0.8170 | 0.7794 | 0.6919 | 0.9329 | 0.9587 | 0.9885 | 2026-08-04 |
| 4 | [`Qwen/Qwen3-Embedding-8B`](mteb/ctdc_synthetic/Qwen__Qwen3-Embedding-8B/) | 0.7783 | 0.8163 | 0.7781 | 0.6873 | 0.9331 | 0.9575 | 0.9896 | 2026-08-04 |
| 5 | [`nvidia/llama-embed-nemotron-8b`](mteb/ctdc_synthetic/nvidia__llama-embed-nemotron-8b/) | 0.7782 | 0.8161 | 0.7782 | 0.6883 | 0.9325 | 0.9580 | 0.9880 | 2026-08-13 |
| 6 | [`Qwen/Qwen3-Embedding-4B`](mteb/ctdc_synthetic/Qwen__Qwen3-Embedding-4B/) | 0.7731 | 0.8109 | 0.7729 | 0.6844 | 0.9277 | 0.9540 | 0.9861 | 2026-08-04 |
| 7 | [`microsoft/harrier-oss-v1-0.6b`](mteb/ctdc_synthetic/microsoft__harrier-oss-v1-0.6b/) | 0.7727 | 0.8101 | 0.7725 | 0.6848 | 0.9256 | 0.9508 | 0.9846 | 2026-08-04 |
| 8 | [`Octen/Octen-Embedding-8B`](mteb/ctdc_synthetic/Octen__Octen-Embedding-8B/) | 0.7585 | 0.7997 | 0.7583 | 0.6596 | 0.9263 | 0.9532 | 0.9878 | 2026-08-04 |
| 9 | [`intfloat/multilingual-e5-large`](mteb/ctdc_synthetic/intfloat__multilingual-e5-large/) | 0.7562 | 0.7981 | 0.7561 | 0.6565 | 0.9272 | 0.9536 | 0.9874 | 2026-08-04 |
| 10 | [`jinaai/jina-embeddings-v5-text-small`](mteb/ctdc_synthetic/jinaai__jina-embeddings-v5-text-small/) | 0.7402 | 0.7810 | 0.7400 | 0.6468 | 0.9075 | 0.9365 | 0.9786 | 2026-08-04 |
| 11 | [`intfloat/multilingual-e5-small`](mteb/ctdc_synthetic/intfloat__multilingual-e5-small/) | 0.7227 | 0.7658 | 0.7226 | 0.6236 | 0.8989 | 0.9299 | 0.9745 | 2026-08-04 |
| 12 | [`codefuse-ai/F2LLM-v2-8B`](mteb/ctdc_synthetic/codefuse-ai__F2LLM-v2-8B/) | 0.6989 | 0.7471 | 0.6987 | 0.5873 | 0.8961 | 0.9304 | 0.9778 | 2026-08-04 |
| 13 | [`codefuse-ai/F2LLM-v2-14B`](mteb/ctdc_synthetic/codefuse-ai__F2LLM-v2-14B/) | 0.6957 | 0.7448 | 0.6956 | 0.5794 | 0.8959 | 0.9319 | 0.9792 | 2026-08-04 |
| 14 | [`google/embeddinggemma-300m`](mteb/ctdc_synthetic/google__embeddinggemma-300m/) | 0.6881 | 0.7321 | 0.6879 | 0.5893 | 0.8691 | 0.9050 | 0.9612 | 2026-08-04 |
| 15 | [`geevec-ai/geevec-embeddings-1.0-lite`](mteb/ctdc_synthetic/geevec-ai__geevec-embeddings-1.0-lite/) | 0.5885 | 0.6349 | 0.5882 | 0.4883 | 0.7802 | 0.8338 | 0.9212 | 2026-08-04 |
